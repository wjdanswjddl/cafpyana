...
#    -c configs/numucc_1p0pi/sel_all-mc.py \
#    -l $list \
#    -o sel_all-mc-DENT1 -ngrid 500

#list="/exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/DENT/CV_newbatch_xrootd.list"
#python run_df_maker.py \
#    -c configs/numucc_1p0pi/sel_all-mc.py \
#    -l $list \
#    -o sel_all-mc-CV2 -ngrid 500

#list="/exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/DENT/DENT_newbatch_xrootd.list"
#python run_df_maker.py \
#    -c configs/numucc_1p0pi/sel_all-mc.py \
#    -l $list \
#    -o sel_all-mc-DENT2 -ngrid 500
...
python run_df_maker.py \
    -c configs/numucc_1p0pi/sel_all-mc.py \
    -l $list \
    -o sel_all-mc-WireMod-CV -ngrid 500
