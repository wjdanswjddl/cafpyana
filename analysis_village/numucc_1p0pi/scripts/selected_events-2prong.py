...
df_dir = "/exp/sbnd/data/users/munjung/xsec/2025Spring_v10_06_00_09/MC/BNB_cosmics/AR23p"
keys2load_data = ['hdr', 'evt']
df_data = dfs_from_dir(search_dir=df_dir, filename_str="2prong_aa", keys2load=keys2load_data, n_max_concat=999)
...
for var_config in var_configs:
    ...
    # for breakdown_type in ["topology", "genie", "genie_sb"]:
        ...
        print("Saved plot in ", path.join(save_fig_dir_crosser_fwd, "{}_{}".format(var_config.var_save_name, breakdown_type)))
