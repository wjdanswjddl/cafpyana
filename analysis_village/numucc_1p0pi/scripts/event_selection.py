...
parser.add_argument('--syst_tag', type=str, default="", help='Systematic tag to use for event selection')
args = parser.parse_args()

syst_tag = args.syst_tag
print("Processing syst_tag: ", syst_tag)
# syst_tag = "CV"
# syst_tag = ""
...
data_df, intime_df, dirt_df = (
    ...
    for df in (data_df, intime_df, dirt_df)
)
