...
if __name__ == "__main__":
    ...
    # syst_lists = [bnb_systematics_xsec, bnb_systematics_hadron] #, bnb_systematics_beam]
    # for gidx, bnb_tag in enumerate(["xsec", "hadron"]):

    syst_lists = [bnb_systematics_beam]
    for gidx, bnb_tag in enumerate(["beam"]):

        syst_type = f"flux-{bnb_tag}"
        syst_list = syst_lists[gidx]
        df_tag = ""
        subdir = f"flux_wgts-{bnb_tag}"
