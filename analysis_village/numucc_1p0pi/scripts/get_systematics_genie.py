...
from analysis_village.numucc_1p0pi.syst_genie_cov import (  # noqa: E402
    XSEC_COMPONENTS,
    _empty_xsec_tensor_acc,
    _ensure_univ_from_leaf,
    _infer_multisim_n_univ,
    _iter_leaf_strings,
    _multisigma_divide_by_cv_enabled,
    _block_column_weight_leaf,
    _replace_first_nonempty_segment,
    _xsec_cv_tensors,
    accumulate_xsec_path_chunk,
    finalize_cv_sel_reco_xsec,
    finalize_xsec_univ_events,
...
# Universe + xsec helpers: imported from syst_genie_cov (see imports above).
...
# ---------------------------------------------------------------------------
# XSEC-path accumulation — imported from syst_genie_cov (above)
# ---------------------------------------------------------------------------
