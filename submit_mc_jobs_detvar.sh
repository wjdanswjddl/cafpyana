...
#python run_df_maker.py -c configs/numucc_1p0pi/sel_2prong-updatecalo.py -l /exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/2025Spring_v10_06_00_10/mc_MCP2025B_1e20_10_prodgenie_corsika_proton_rockbox_sbnd_SystVar_0xSCE_caf_flat_caf_sbnd_xrootd.list -o sel_2prong-mc-BNB_cosmics-0xSCE -ngrid 1000
#python run_df_maker.py -c configs/numucc_1p0pi/sel_2prong-updatecalo.py -l /exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/2025Spring_v10_06_00_10/mc_MCP2025B_1e20_10_prodgenie_corsika_proton_rockbox_sbnd_SystVar_2xSCE_caf_flat_caf_sbn_xrootd.list -o sel_2prong-mc-BNB_cosmics-0xSCE -ngrid 1000
#
...
python run_df_maker.py -c configs/numucc_1p0pi/sel_mup-updatecalo.py -l $filextxw -o sel_mup-mc-WireModXTXW -ngrid 3000
...
python run_df_maker.py -c configs/numucc_1p0pi/sel_mup-updatecalo.py -l $fileyz -o sel_mup-mc-WireModYZ -ngrid 3000
