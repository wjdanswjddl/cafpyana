...
filextxw="/exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/WireMod/mc_SBND2026A_prodgenie_corsika_proton_rockbox_sbnd_wiremod_X-ThetaXW_v10_06_00_10_flatcaf_sbnd_xrootd.list"
python run_df_maker.py -c configs/numucc_1p0pi/sel_2prong-updatecalo.py -l $filextxw -o sel_2prong-mc-WireModXTXW -ngrid 3000
#
fileyz="/exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/WireMod/mc_SBND2026A_prodgenie_corsika_proton_rockbox_sbnd_SV_v10_06_00_10_flatcaf_sbnd_xrootd.list"
python run_df_maker.py -c configs/numucc_1p0pi/sel_2prong-updatecalo.py -l $fileyz -o sel_2prong-mc-WireModYZ -ngrid 3000
...
##python run_df_maker.py -c configs/numucc_1p0pi/sel_2prong-updateefield.py -l $filecv -o sel_mup-mc-BNB_cosmics-efieldvar #-ngrid 3000
