...
for g in CCQE ZExp MEC RES nonRES DIS Other; do
...
ar23_inputdir=/exp/sbnd/app/users/munjung/misc/filelists/MC/SBND/Ar23+
ar23_list="${ar23_inputdir}/ar23p_respin-xrootd.list"
